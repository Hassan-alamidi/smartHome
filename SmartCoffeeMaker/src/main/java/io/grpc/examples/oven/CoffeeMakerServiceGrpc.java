...
public final class CoffeeMakerServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.grpc.examples.oven.BrewType,
      io.grpc.examples.oven.StringResponse> getSetBrewingTypeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "setBrewingType",
      requestType = io.grpc.examples.oven.BrewType.class,
      responseType = io.grpc.examples.oven.StringResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.grpc.examples.oven.BrewType,
      io.grpc.examples.oven.StringResponse> getSetBrewingTypeMethod() {
    io.grpc.MethodDescriptor<io.grpc.examples.oven.BrewType, io.grpc.examples.oven.StringResponse> getSetBrewingTypeMethod;
      ...
      synchronized (CoffeeMakerServiceGrpc.class) {
        if ((getSetBrewingTypeMethod = CoffeeMakerServiceGrpc.getSetBrewingTypeMethod) == null) {
          CoffeeMakerServiceGrpc.getSetBrewingTypeMethod = getSetBrewingTypeMethod = 
              io.grpc.MethodDescriptor.<io.grpc.examples.oven.BrewType, io.grpc.examples.oven.StringResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "coffeeMaker.CoffeeMakerService", "setBrewingType"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.examples.oven.BrewType.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.grpc.examples.oven.Empty,
      io.grpc.examples.oven.StringResponse> getBeginBrewingMethod;
  ...
  public static io.grpc.MethodDescriptor<io.grpc.examples.oven.Empty,
      io.grpc.examples.oven.StringResponse> getBeginBrewingMethod() {
    io.grpc.MethodDescriptor<io.grpc.examples.oven.Empty, io.grpc.examples.oven.StringResponse> getBeginBrewingMethod;
  ...
  public static abstract class CoffeeMakerServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void setBrewingType(io.grpc.examples.oven.BrewType request,
    ...
    /**
     */
    public void beginBrewing(io.grpc.examples.oven.Empty request,
        io.grpc.stub.StreamObserver<io.grpc.examples.oven.StringResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.grpc.examples.oven.BrewType,
  ...
  public static final class CoffeeMakerServiceBlockingStub extends io.grpc.stub.AbstractStub<CoffeeMakerServiceBlockingStub> {
    ...
    /**
     */
    public io.grpc.examples.oven.StringResponse setBrewingType(io.grpc.examples.oven.BrewType request) {
    ...
    /**
     */
    public java.util.Iterator<io.grpc.examples.oven.StringResponse> beginBrewing(
  ...
  public static final class CoffeeMakerServiceFutureStub extends io.grpc.stub.AbstractStub<CoffeeMakerServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.grpc.examples.oven.StringResponse> setBrewingType(
        io.grpc.examples.oven.BrewType request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SET_BREWING_TYPE:
          serviceImpl.setBrewingType((io.grpc.examples.oven.BrewType) request,
              (io.grpc.stub.StreamObserver<io.grpc.examples.oven.StringResponse>) responseObserver);
          break;
        case METHODID_BEGIN_BREWING:
          serviceImpl.beginBrewing((io.grpc.examples.oven.Empty) request,
              (io.grpc.stub.StreamObserver<io.grpc.examples.oven.StringResponse>) responseObserver);
          break;
        default:
